...
<head>
    ...
    <title>Heroes: Quotation Requested</title>
    <style>
        .container {
            margin: 0 auto;
            max-width: 600px;
...
<div class="container">
    ...
    <div class="content">
        ...
        <br>
        <p style="font-size: 14px; text-align: justify">There is a new quotation requested by {{ $school->school_name }}. Please proceed to review the request.</p>
        <br>
        <p><b>School Information</b></p>
        <p>
