...
<head>
    ...
    <title>Heroes: Order Payment Received</title>
    <style>
        .container {
            margin: 0 auto;
            max-width: 600px;
...
<div class="container">
    ...
    <div class="content">
        ...
        <br>
        <p style="font-size: 14px; text-align: justify">There is a new order payment received from {{ $school->school_name }}, please proceed to issue invoice once payment is confirmed.</p>
        <br>
